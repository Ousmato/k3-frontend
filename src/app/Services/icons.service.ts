...
import { faUsers, faGear, faTable, faChartArea, faHome, faBars, faGraduationCap, faSchool, faUser, faCog, faAngleDown, faSearch, faBookOpen, faAngleUp, faEye, faTrashCan, faEdit, faPenToSquare, faArrowRight, faClock, faPlus, faCalendarCheck, faTrash, faHandHoldingDollar, faPaperPlane, faCircleChevronRight, faPlusCircle, faSquarePlus, faFolderOpen, faSquareCheck, faSquareXmark, faArrowsLeftRight, faArrowRightArrowLeft, faFolder, faBan, faXmark, faRotate, faRotateRight, faEyeSlash, faArrowLeft, faAngleRight, faAngleLeft, faSignOut, faList, faCableCar, faCalendarDay, faCalendarPlus, faUserPlus, faCloudArrowUp, faCreditCard, faUsersViewfinder, faFilePdf, faHandPointDown, faCircleCheck, faMinusCircle, faBoxArchive, faFileImport, faUserCheck, faCircleXmark, faTriangleExclamation, faCheckDouble, faSortUp, faSortDown, faCircle, faImage, faEnvelope, faLock, faEnvelopeOpen, faBell, faFilter, faInfoCircle, faBook } from '@fortawesome/free-solid-svg-icons';
